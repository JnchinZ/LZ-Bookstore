...
<div class="gallery">
	...
	<div class="container" style="width: 400px;margin-top: 100px;">
		<h2 style="text-align: center;">欢迎您的加入</h2>
		<br />
		<div class="row">
			<div class="col-xs-4 col-md-offset-10">
				<h4><a href="${pageContext.request.contextPath }/user/loginUI.action">去登陆&gt;&gt;</a></h4>
			</div>
		</div>
	</div>
</div>
