drop database lz;
create database lz default charset utf8;
use lz;
DROP TABLE IF EXISTS lz_book;
CREATE TABLE lz_book (
  id int(12) NOT NULL auto_increment,
  bookName varchar(100) NOT NULL,
  bookSummary varchar(100) default NULL,
...
INSERT INTO lz_book VALUES (1,'一个陌生女人的来信','一个男子在四十一岁生日当天收到一封没有署名和地址的信，一个临死的女人，讲述了一个刻骨铭心的爱情故事，而故事的男主人公也就是收信的这个男人对此一无所知。',26.00,15.90,'16.jpg','斯蒂芬·茨威格','上海译文出版社',1214841600000,
...
INSERT INTO lz_book VALUES (2,'鲁滨逊漂流记','主要讲述了主人公因出海遇难，漂流到无人岛（原名马萨蒂埃拉岛，后来以《鲁滨逊漂流记》中主人公鲁滨逊的名字重新命名：鲁滨逊·克鲁索岛），并坚持在岛上生活，最后回到社会的故事。',15.80,11.10 ,'17.jpg','丹尼尔·笛福','世界图书出版公司',1209571200000,
...
INSERT INTO lz_book VALUES (3,'老子说','老子是一位真正的智者，他不仅教人表现柔弱、愚鲁，更教人无为、无我、居下、退后、清滤、自然……他的思想很难叫人接受，因为一般人只能看到事物的外表，而老子却看到了内里。',30.00,24.60,'18.jpg','蔡志忠','地理出版社',1072886400000,
...
INSERT INTO lz_book VALUES (4,'达芬奇密码','哈佛大学的符号学专家罗伯特·兰登在法国巴黎出差期间的一个午夜接到一个紧急电话，得知卢浮宫博物馆年迈的馆长被人杀害在卢浮宫的博物馆里，人们在他的尸体旁边发现了一个难以捉摸的密码。',28.00,25.20,'19.jpg','丹.布朗 ','上海人民出版社',1072886400000,
'丹·布朗堪称今日美国最著名畅销书作家。他的小说《达·芬奇密码》自问世以来，一直高居《纽约时报》畅销书排行榜榜首。','无');

INSERT INTO lz_book VALUES (5,'淘气包马小跳','马小跳和路曼曼是一对同桌冤家，路曼曼要管着马小跳。马小跳却不喜欢路曼曼总管着他，他们之间永远有吵不完的架。',13,9.9,'20.jpg','杨红樱  ','接力出版社',1136044800000,
...
INSERT INTO lz_book VALUES (6,'夏洛的网','本书描述一个名叫夏洛的蜘蛛如何巧妙的拯救险成火腿的小猪威伯，并化解了它的存亡问题。',28,24.36,'21.jpg',
...
INSERT INTO lz_book VALUES (7,'Servlet与JSP核心编程','本书由浅入深，全面而深入地介绍了servlet和jsp技术。',59,44.25,'22.jpg',
...
INSERT INTO lz_book VALUES (8,'庐隐作品精编',' 本书收入了庐隐具有代表性的散文和小说',22.00,18.00,'23.jpg','庐隐 ','漓江出版社',1080748800000,
'庐隐(1898．5．4～1934．5．13)原名黄淑仪，又名黄英，生于福建闽侯。','散文/窗外的春光/我愿秋常驻人间/蓬莱风景线/生命的光荣——叩苍从狱中寄来的信......');

INSERT INTO lz_book VALUES (9,'门口的野蛮人','再现了华尔街历史上最著名的公司争夺战——对美国RJR纳贝斯克公司的争夺战。 ',39,18,'24.jpg',
...
INSERT INTO lz_book VALUES (10,'童年 在人间 我的大学','《童年 在人间 我的大学(权威全译典藏版)》取材于高尔基的真实成长经历，主人公阿廖沙便是作者“我”。',30,18,'2.jpg',
...
INSERT INTO lz_book VALUES (11,'海水观赏鱼：宠物100','覆盖地球表面77%的海洋，给种类繁多的海洋生物提供了备具特色的栖息场所，世界上已查明的海洋鱼类约有2万余种。',25,19.6,'3.jpg','张词祖','中国林业出版社',1046448000000,
'张词祖 - 1940～,上海人,高级工程师,中国动物学会会员,中国摄影家协会会员,中国科普作家协会会员出版过著作、动物画册及摄影丛书,包括《中国野鸟》等','无');

INSERT INTO lz_book VALUES (12,'小妇人','本书以19世纪中期美国南北战争为背景，生动描写了作者亲身经历的家庭生活',40,23.7,'4.jpg','奥尔科特','上海译文出版社',
...
INSERT INTO lz_book VALUES (13,'双螺旋','这本书讲述了发现dna——由两条被称为“碱基”的简单化学链相互缠绕成一个双螺旋结构——的真实故事。',35,24.7,'5.jpg','（美）沃森 ','生活·读书·新知三联书店',996595200000,'詹姆斯·沃森（james d.watson）1928年出生于芝加哥。','无');
INSERT INTO lz_book VALUES (14,'简爱','《简·爱》是夏洛蒂的第二部小说。她借一个出身寒微的年轻女子奋斗的经历，抒发了自己胸中的积愫，深深打动了当时的读者。',20,18,'6.jpg',
...
INSERT INTO lz_book VALUES (15,'java就业培训教程','本书作者张孝祥曾以技术入股清华创业园某公司，任该公司技术总监，带领导十几位清华博士、硕士组成的技术团队，开发了文件分发软件，屏幕共享软件，远程教学系统，视频监控与会议系统。',41,34.8,'7.jpg',' 张孝祥   ','清华大学出版社',1062345600000,
...
INSERT INTO lz_book VALUES (16,'茶花女','《茶花女》是法国亚历山大·小仲马的代表作，讲述在19世纪40年代，一个叫玛格丽特·戈蒂埃的贫苦乡下姑娘来到巴黎，走进了名利场，成了上流社会的一个社交明星。',18,12.78,
'8.jpg','[法] 亚历山大·小仲马著  ','译林出版社',1388505600000,'小仲马（1824—1895）是法国小说家、剧作家。他的文学创作大多以探讨社会道德问题为主题。','无');

INSERT INTO lz_book VALUES (17,'雪莱诗选','雪莱诗选》几乎提取了雪莱众多诗篇中的全部精华，其中包括那很多人知晓、熟诵的《云雀歌》、《西风颂》',
22,18.92,'9.jpg','(英)雪莱   ','人民文学',1346428800000,'作者：（英国）雪莱（Shelley P.B.）','目录\爱尔兰人之歌 \致爱尔兰 \诗章 \无常 \咏死 \夏日黄昏的墓园 \赞精神的美...... ');

INSERT INTO lz_book VALUES (18,'在人间','在人间》内容简介：阿廖沙11岁，他的母亲去世，外祖父破产，他走上社会，开始独立谋生。',20,18.40,'10.jpg',
'(俄)高尔基著 ','上海文艺出版社',1354291200000,'高尔基(1868～1936)前苏联无产阶级作家,社会主义现实主义文学的奠基人。','无');

INSERT INTO lz_book VALUES (19,'飘','飘》是一部有关战争的小说，但作者玛格丽特没有把着眼点放在战场上。',25,23.5,'11.jpg','（美）米切尔','译林出版社',1275321600000,
'仅仅写了一部作品就名扬天下并在文坛上占有一席之地的作家是绝无仅有的。而美国女作家玛格丽特·米切尔便是这样一位绝无仅有的作家。','目录第一部第一章第二章第三章第四章第五章第六章第七章	......');

INSERT INTO lz_book VALUES (20,'关键管理问题',' 这本书是为忙碌又缺乏培训的成功人士而设计的工具书。这并不意味着如果读者选择一页一页地阅读就不行。',
...
INSERT INTO lz_book VALUES (21,'孩子，我们一路同行','我们正在走向学习化的社会，家庭是社会的细胞，它要求家长改变过去粗放式的家庭教育理念和方式。',10.00,9.00,'13.jpg',' 王晓春 ','中国妇女出版社',1054396800000,
...
INSERT INTO lz_book VALUES (22,'傲慢与偏见','《傲慢与偏见》是简·奥斯汀的代表作。故事围绕贝内特一家几个女儿的婚姻大事展开。',25,19,'14.jpg',
'奥斯汀 ','花城',1091289600000,'《傲慢与偏见》是简·奥斯汀的代表作。小说讲述了乡绅之女伊丽莎白·班内特的爱情故事。','目录第一章第二章第三章第四章第五章第六章第七章第八章第九章......');

INSERT INTO lz_book VALUES (23,'童年','《童年》讲述的是孤独孩童“我”的成长故事。小说以一个孩子的独特视角来审视整个社会及人生。',22,16,'15.jpg',
'（苏）高尔基原著   ','陕西师范大学出版社',1257004800000,'高尔基(1868～1936)前苏联无产阶级作家,社会主义现实主义文学的奠基人。','目录\编辑缘起\译者序\主要人物表\一\二\三\四\五\六\七\八\九\十\十一\十二\十三 ......');

select * from lz_book;


DROP TABLE IF EXISTS lz_item;
CREATE TABLE lz_item (
  id int(12) NOT NULL auto_increment,
...
INSERT INTO lz_user VALUES (1,'admin','admin','admin',1234567890,'123@qq.com',
'山东科技大学泰安西校区','headshot.png',1);

select * from lz_user;


select * from lz_order;
select * from lz_item;
